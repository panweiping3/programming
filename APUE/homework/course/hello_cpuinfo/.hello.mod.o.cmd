cmd_/root/learn_driver/hello.asm/hello.mod.o := gcc -m32 -Wp,-MD,/root/learn_driver/hello.asm/.hello.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i386-asianux-linux/4.1.1/include -Iinclude/asm/mach-xen -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -D__XEN_INTERFACE_VERSION__=0x00030203 -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Wstrict-prototypes -Wundef -Werror-implicit-function-declaration -Os -pipe -msoft-float -fno-builtin-sprintf -fno-builtin-log2 -fno-builtin-puts  -mpreferred-stack-boundary=2  -march=i686 -mtune=generic -mtune=generic -mregparm=3 -ffreestanding -Iinclude/asm-i386/mach-xen -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(hello.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(hello)" -DMODULE -c -o /root/learn_driver/hello.asm/hello.mod.o /root/learn_driver/hello.asm/hello.mod.c

deps_/root/learn_driver/hello.asm/hello.mod.o := \
  /root/learn_driver/hello.asm/hello.mod.c \
...
/root/learn_driver/hello.asm/hello.mod.o: $(deps_/root/learn_driver/hello.asm/hello.mod.o)
