...
void WidgetGally::changeStyle(const QString &styleName)
{
...
void WidgetGally::changePalette()
{
...
void WidgetGally::advanceProgressBar()
{
...
void WidgetGally::createTopLeftGroupBox()
{
...
void WidgetGally::createTopRightGroupBox()
{
...
void WidgetGally::createBottomLeftGroupBox()
{
    bottomLeftTabWidget = new QTabWidget;
    bottomLeftTabWidget->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
...
void WidgetGally::createProgressBar()
{
