              ...
              <li class="profile">\
                <div class="icon on-profile-icon"><img src="'+currUser.avatar+'" class="curr-icon-img">\
                  <div class="wrap clearfix">\
                    ...
                    <div class="ft clearfix"><a target="_blank" href="https://passport.csdn.net/account/profile?ref=toolbar" class="pull-left"><span class="icon settings"></span>设置</a><a href="https://passport.csdn.net/account/logout?ref=toolbar"  target="_top" class="pull-right"><span class="icon quit"></span>退出</a></div>\
                  </div>\
                </div>\
              </li>\
              <li class="apps">\
